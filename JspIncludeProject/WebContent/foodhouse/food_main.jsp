...
<%@page import="com.sist.foodhouse.dao.CategoryVO"%>
<%@page import="java.util.ArrayList"%>
<%@ page language="java" contentType="text/html; charset=EUC-KR"
	pageEncoding="EUC-KR"%>
<jsp:useBean id="dao" class="com.sist.foodhouse.dao.FoodDAO"></jsp:useBean>
<%
	ArrayList<CategoryVO> list = dao.catagoryAllData();
%>
<!DOCTYPE html>
<html>
<head>
...
%>
				<div class="qitem">
					<img src="<%=vo.getPoster()%>"width="150" height="120"/>
						<span class="caption">
						<h4><%=vo.getTitle() %></h4>
						<p><%=vo.getSubject() %></p>
					</span>
